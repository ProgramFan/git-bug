...
func NewEditCommentOp(author *identity.Identity, unixTime int64, target git.Hash, message string, files []git.Hash) *EditCommentOperation {
...
func EditComment(b Interface, author *identity.Identity, unixTime int64, target git.Hash, message string) (*EditCommentOperation, error) {
	return EditCommentWithFiles(b, author, unixTime, target, message, nil)
}

func EditCommentWithFiles(b Interface, author *identity.Identity, unixTime int64, target git.Hash, message string, files []git.Hash) (*EditCommentOperation, error) {
