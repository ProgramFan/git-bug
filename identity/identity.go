// Package identity contains the identity data model abd low-level related functions
package identity
...
func (i *Identity) Name() string {
	return i.Versions[len(i.Versions)-1].Name
}

// Email return the last version of the email
func (i *Identity) Email() string {
	return i.Versions[len(i.Versions)-1].Email
}

// Login return the last version of the login
func (i *Identity) Login() string {
	return i.Versions[len(i.Versions)-1].Login
}

// Login return the last version of the Avatar URL
func (i *Identity) AvatarURL() string {
	return i.Versions[len(i.Versions)-1].AvatarUrl
}

// Login return the last version of the valid keys
func (i *Identity) Keys() []Key {
	return i.Versions[len(i.Versions)-1].Keys
}
